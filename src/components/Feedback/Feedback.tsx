    ...
    <section className="section feedback">
      <div className="section__wrapper feedback__wrapper">
        ...
        <form className="feedback__form">
          ...
          />
          <textarea
            className="feedback__form-input feedback__form-textarea"
            placeholder="Комментарий"
          />
          <label className="feedback__checkbox">
            <input
              type="checkbox"
              className="feedback__form__checkbox-switcher"
            />
          ...
          <button className="feedback__form-button-submit" type="submit">
            Отправить вопрос
          </button>
        </form>
      </div>
