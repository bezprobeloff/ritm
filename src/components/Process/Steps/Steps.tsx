    ...
    <div className='steps'>
      ...
      <ul className='section__list steps__list'>
        <li className='section__item steps__item'>
          ...
          <p className='advantage__item-title steps__item-title'>Постановка задачи</p>
        ...
        <li className='section__item steps__item'>
          ...
          <p className='advantage__item-title steps__item-title'>Техническое задание</p>
          <p className='advantage__item-description steps__item-description'>
        ...
        <li className='section__item steps__item'>
          ...
          <p className='advantage__item-title steps__item-title'>Коммерческое предложение</p>
          <p className='advantage__item-description steps__item-description'>
        ...
        <li className='section__item steps__item'>
          ...
          <p className='advantage__item-title steps__item-title'>Заключение договора</p>
          <p className='advantage__item-description steps__item-description'>
        ...
        <li className='section__item steps__item'>
          ...
          <p className='advantage__item-title steps__item-title'>Запуск продукта</p>
          <p className='advantage__item-description steps__item-description'>
        ...
        <li className='section__item steps__item'>
          ...
          <p className='advantage__item-title steps__item-title'>Поддержка продукта</p>
          <p className='advantage__item-description steps__item-description'>
